...
class SessionsSenecaClientV1 extends pip_services_seneca_node_1.CommandableSenecaClient {
    constructor(config) {
        super('sessions');
        if (config != null)
...
exports.SessionsSenecaClientV1 = SessionsSenecaClientV1;
//# sourceMappingURL=SessionsSenecaClientV1.js.map